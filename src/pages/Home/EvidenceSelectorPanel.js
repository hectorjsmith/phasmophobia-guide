...
export const EvidenceSelectorPanel = ({evidence, ghosts, toggleSyncModal}) => {
          ...
          {evidence.map((e) => {
            return (
              <ObservationToggle
                ...
                isAvailable={anyVisibleGhostWithEvidence(ghosts, selectedEvidence(), rejectedEvidence(), e.id)}
              />
            )
          })}
